...
//go:generate minimock -g -i github.com/nskondratev/socks5-proxy-server/proxy/internal/bot/middleware.adminService -o admin_service_mock_test.go -n AdminServiceMock -p middleware
