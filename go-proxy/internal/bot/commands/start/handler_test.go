...
//go:generate minimock -g -i github.com/nskondratev/socks5-proxy-server/internal/bot/commands/start.userStateSetter -o user_state_setter_mock_test.go -n UserStateSetterMock -p start
