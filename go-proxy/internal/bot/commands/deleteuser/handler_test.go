...
//go:generate minimock -g -i github.com/nskondratev/socks5-proxy-server/internal/bot/commands/deleteuser.stateStore -o state_store_mock_test.go -n StateStoreMock -p deleteuser
