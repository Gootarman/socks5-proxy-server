...
//go:generate minimock -g -i github.com/nskondratev/socks5-proxy-server/internal/bot/commands/createuser.stateStore -o state_store_mock_test.go -n StateStoreMock -p createuser
